...
export default function Shell({ title, children, refreshing }: { title: string; children: React.ReactNode; refreshing?: boolean }) {
  ...
  return (
    ...
    <AppShell accent="#d4694a" maxHeight={932} style={{ height: "var(--shell-h)" }}>
      <AppShellHeader>
        {/* 헤더(sticky=positioned)에 앵커 — 하단 보더 위 얇은 스윕 로딩바 */}
        {refreshing && <div className="toploader" aria-hidden />}
