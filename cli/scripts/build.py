...
try:
    with open(os.path.join(os.environ.get("USAGE_REPORT_TMP", "/tmp"), "codex.json")) as _cf:
...
try:
    with open(os.path.join(os.environ.get("USAGE_REPORT_TMP", "/tmp"), "viberank.json")) as _vf:
