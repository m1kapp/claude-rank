...
const DICT: Dict = {
  ...
  "user.modelsEstimated": { ko: "모델별 비용은 추정 — Codex 원본은 하루 단위 비용만 주므로 모델 토큰 비중으로 나눴다", en: "Per-model cost is estimated — Codex reports cost per day, so it is split by each model's token share" },
  ...
  "codex.connectHint": { ko: "이 달 Codex 기록이 없어요. 같은 기기에서 npx @m1kapp/runmaxing 을 한 번 돌리면 Codex 레인도 함께 올라갑니다.", en: "No Codex record this month. Run npx @m1kapp/runmaxing on the same machine and the Codex lane fills in too." },
