...
const DICT: Dict = {
  ...
  "start.s3.desc": { ko: "이 한 줄이면 끝이에요. 요금제는 자동 판별, 닉네임도 자동(이메일 앞부분)이라 그냥 /claude-run 만. 다른 닉을 원하면 /claude-run <닉> 한 번.", en: "Just this one line. Plan is auto-detected and your nickname defaults to your email prefix — so /claude-run alone works. Want a custom name? /claude-run <name> once." },
