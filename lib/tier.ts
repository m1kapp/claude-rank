...
export type Tier = { key: string; ko: string; minUsd: number; color: string };

export const TIERS: Tier[] = [
  { key: "iron", ko: "아이언", minUsd: 0, color: "#7d7d7d" },
  { key: "bronze", ko: "브론즈", minUsd: 30, color: "#a6713f" },
  { key: "silver", ko: "실버", minUsd: 80, color: "#9aa4ad" },
  { key: "gold", ko: "골드", minUsd: 150, color: "#d4af37" },
  { key: "platinum", ko: "플래티넘", minUsd: 300, color: "#3fb6a8" },
  { key: "emerald", ko: "에메랄드", minUsd: 600, color: "#2ea66b" },
  { key: "diamond", ko: "다이아", minUsd: 1200, color: "#5b8ed6" },
  { key: "master", ko: "마스터", minUsd: 2500, color: "#a25fd0" },
  { key: "grandmaster", ko: "그랜드마스터", minUsd: 5000, color: "#d0473b" },
  { key: "challenger", ko: "챌린저", minUsd: 10000, color: "#e8c75a" },
];
